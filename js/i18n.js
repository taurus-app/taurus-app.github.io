...
window.I18N_DICT = {
	en: {
		...
		'dashboard.nodeParticipation': 'Join Node',
		'dashboard.superNodeParticipation': 'Join Super Node',
		'dashboard.checkingEligibility': 'Checking eligibility...',
		'dashboard.joinNode': 'Join Node',
		'dashboard.nodeNotEligible': 'Not eligible for node participation',
		'dashboard.nodeT3T6': 'T3-T6 Node',
		'dashboard.nodeT6Plus': 'T6+ Node',
		'dashboard.nodeRequirements': 'Requirements not met',
		'dashboard.nodeJoining': 'Joining node...',
		'dashboard.nodeJoined': 'Successfully joined node',
		'dashboard.superNodeJoined': 'Successfully joined super node',
		'dashboard.nodeFailed': 'Failed to join node',
		'dashboard.superNodeFailed': 'Failed to join super node',
		'dashboard.nodeEligible': 'You are eligible to join node',
		'dashboard.approveTaurus': 'Approve Taurus',
		'dashboard.currentNodes': 'Current Nodes:',
		'dashboard.remainingSlots': 'Remaining Slots:'
	},
	zh: {
		'dashboard.title': '仪表盘',
		'dashboard.back': '返回',
		...
		'dashboard.nodeParticipation': '参与节点',
		'dashboard.superNodeParticipation': '参与超级节点',
		'dashboard.checkingEligibility': '检查资格中...',
		'dashboard.joinNode': '参与节点',
		'dashboard.nodeNotEligible': '不满足参与节点要求',
		'dashboard.nodeT3T6': 'T3-T6节点',
		'dashboard.nodeT6Plus': 'T6+节点',
		'dashboard.nodeRequirements': '未满足参与节点要求',
		'dashboard.nodeJoining': '正在参与节点...',
		'dashboard.nodeJoined': '成功参与节点',
		'dashboard.superNodeJoined': '成功参与超级节点',
		'dashboard.nodeFailed': '参与节点失败',
		'dashboard.superNodeFailed': '参与超级节点失败',
		'dashboard.nodeEligible': '您已满足参与节点的要求',
		'dashboard.approveTaurus': '授权 Taurus',
		'dashboard.currentNodes': '当前节点数:',
		'dashboard.remainingSlots': '剩余节点名额:'
	},
	ko: {
		...
		'dashboard.nodeParticipation': '노드 참여',
		'dashboard.superNodeParticipation': '슈퍼 노드 참여',
		'dashboard.checkingEligibility': '자격 확인 중...',
		'dashboard.joinNode': '노드 참여',
		'dashboard.nodeNotEligible': '노드 참여 자격 없음',
		'dashboard.nodeT3T6': 'T3-T6 노드',
		'dashboard.nodeT6Plus': 'T6+ 노드',
		'dashboard.nodeRequirements': '요구사항 미충족',
		'dashboard.nodeJoining': '노드 참여 중...',
		'dashboard.nodeJoined': '노드 참여 성공',
		'dashboard.superNodeJoined': '슈퍼 노드 참여 성공',
		'dashboard.nodeFailed': '노드 참여 실패',
		'dashboard.superNodeFailed': '슈퍼 노드 참여 실패',
		'dashboard.nodeEligible': '노드 참여 요구사항 충족',
		'dashboard.approveTaurus': 'Taurus 승인',
		'dashboard.currentNodes': '현재 노드 수:',
		'dashboard.remainingSlots': '남은 노드 슬롯:'
	},
	zh_tw: {
		'dashboard.title': '儀表板',
		'dashboard.back': '返回',
		...
		'dashboard.nodeParticipation': '參與節點',
		'dashboard.superNodeParticipation': '參與超級節點',
		'dashboard.checkingEligibility': '檢查資格中...',
		'dashboard.joinNode': '參與節點',
		'dashboard.nodeNotEligible': '不滿足參與節點要求',
		'dashboard.nodeT3T6': 'T3-T6節點',
		'dashboard.nodeT6Plus': 'T6+節點',
		'dashboard.nodeRequirements': '未滿足參與節點要求',
		'dashboard.nodeJoining': '正在參與節點...',
		'dashboard.nodeJoined': '成功參與節點',
		'dashboard.superNodeJoined': '成功參與超級節點',
		'dashboard.nodeFailed': '參與節點失敗',
		'dashboard.nodeEligible': '您已滿足參與節點的要求',
		'dashboard.approveTaurus': '授權 Taurus',
		'dashboard.currentNodes': '當前節點數:',
		'dashboard.remainingSlots': '剩餘節點名額:'
	}
};
